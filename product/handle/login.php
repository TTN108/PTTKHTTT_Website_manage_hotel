<?php
    function login($username, $password){
        ...
        $sql = "SELECT nhan_vien.Chuc_vu FROM account, nhan_vien WHERE account.Username = nhan_vien.Account and account.Username = '$username' and account.Password = '$password' and account.Status = 'Hoạt động'";        $res = mysqli_query($con, $sql);
